...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        title: "NestJS 实战学习 v1 · 系统路径",
      },
      {
        name: "description",
        content:
          "NestJS 中文交互教程：模块与 DI、请求管道、JWT 工坊、Catppuccin 主题。",
      },
    ],
    links: [
...
const CTP_BOOT =
  "(function(){try{var f=localStorage.getItem('nestjs-learn-ctp-flavor');var a=localStorage.getItem('nestjs-learn-ctp-accent');var okF=['mocha','macchiato','frappe','latte'];var okA=['red','mauve','blue','lavender','sapphire','teal','peach','pink','green'];if(okF.indexOf(f)<0)f='mocha';if(okA.indexOf(a)<0)a='red';document.documentElement.setAttribute('data-ctp-flavor',f);document.documentElement.setAttribute('data-ctp-accent',a);}catch(e){document.documentElement.setAttribute('data-ctp-flavor','mocha');document.documentElement.setAttribute('data-ctp-accent','red');}})();";

function RootDocument({ children }: { children: ReactNode }) {
  return (
    <html lang="zh-CN" data-ctp-flavor="mocha" data-ctp-accent="red">
      <head>
