...
export const CTP_ACCENTS = [
  { id: "red", label: "Red", css: "var(--ctp-red)" },
...
/** Nest 课站独立 storage */
export const CTP_STORAGE_KEY = "nestjs-learn-ctp-flavor";
export const CTP_ACCENT_KEY = "nestjs-learn-ctp-accent";
export const DEFAULT_CTP_FLAVOR: CtpFlavor = "mocha";
/** 默认 Red，贴合 Nest 品牌色 */
export const DEFAULT_CTP_ACCENT: CtpAccent = "red";
